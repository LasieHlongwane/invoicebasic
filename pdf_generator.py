...
class ModernInvoice(FPDF):
    def header(self):
        ...
        self.set_xy(10, 8)
        self.cell(0, 10, getattr(self, 'business_name', 'Invoice'), ln=True)
...
def generate_pdf(data, mode="invoice", output_path=None):
    """
    Generate a modern Airbnb-style invoice PDF using FPDF2.
    ...
    data format:
    {
        ...
        "reference": "INV-001",
        "items": [
            {"description": "Design Work", "quantity": 1, "unit_price": 15000, "total": 15000}
        ]
    }
    """
    ...
    if output_path:
        ...
        # Return PDF as bytes (safe for emailing or download)
